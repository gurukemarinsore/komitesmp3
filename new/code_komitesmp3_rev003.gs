 ...
 * Revisi 1.03 / backend rev003
 * Google Apps Script + Google Spreadsheet
 * Tahun Pelajaran 2026/2027
 * Nominal Komite: Rp50.000 / bulan / siswa
 *
 * Fokus rev003:
 * - Bootstrap staf mengirim status dan riwayat pembayaran ringkas sekaligus agar detail siswa dapat dibuka lokal tanpa request tambahan.
 * - Pembayaran multi-bulan dapat disinkronkan dalam satu request batch, tetap disimpan per bulan di Spreadsheet.
 * - Format kelas ringkas 7A s.d. 7J tetap kompatibel dengan format lama VII A.
 * - Tanggal pembayaran pilihan Bendahara dipertahankan pada sinkronisasi online/offline.
 * - ID transaksi tetap internal untuk idempotensi, log, cetak, dan pembatalan; tidak perlu ditampilkan di UI.
 */
